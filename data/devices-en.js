...
window.ludaData.devices = [
  ...
  },
  {
    ...
    customized: [
      "Can be upgraded to Class 0.5% Accuracy Class",
      "Can be upgraded to Servo Motor Hydraulic System"
    ],
    standards: [
      "ASTM E8",
  ...
  },
  {
    ...
    features: [
      "This apparatus is applicable to silt, silty clay, clay, and environmental soils."
    ],
    customized: [
      "Soil sample diameter and Soil sample height can be customized"
    ],
    standards: [
      "CEN ISO/TS 17892-11"
    ],
  ...
  },
  {
    ...
    specifications: [
      ...
      {
        label: "Range and measurement range",
        value: "150 - 3000 kN"
      },
      {
        label: "Relative indication error",
        value: "±0.5%"
      },
      {
        label: "Maximum tensile test space",
        value: "850 mm"
      },
      {
        label: "Maximum compression test space",
        value: "550 mm"
      },
      {
        label: "Flat specimen gripping thickness",
        value: "0 - 60 mm"
      },
      {
        label: "Round specimen gripping diameter",
        value: "20 - 60 mm"
      },
      {
        label: "Working piston stroke",
        value: "700 mm"
      },
      {
        label: "Upper and lower platen dimensions",
        value: "Φ280 × Φ280 mm"
      },
      {
        label: "Distance between two columns (tension/compression space)",
        value: "680 mm"
      },
      {
        label: "Maximum platen rising speed",
        value: "80 mm/min"
      },
      {
        label: "Total motor power",
        value: "≈3 kW"
      },
      {
        label: "Main machine overall dimensions (L × W × H)",
        value: "1400 × 920 × 3400 mm"
      },
      {
        label: "Load cell cabinet overall dimensions (L × W × H)",
        value: "1110 × 700 × 940 mm"
      },
      {
        label: "Total machine weight",
        value: "≈6500 kg"
      }
    ],
    hasManual: null,
  ...
  },
  {
    ...
    specifications: [
      {
        label: "Maximum vertical space of testing machine",
        value: "600 mm"
      },
      {
        label: "Clear distance between columns",
        value: "X direction: 950 mm, Y direction: 950 mm"
      },
      {
        label: "Main actuator",
        value: "Maximum load :5000 kN"
      },
      {
        label: "Load accuracy",
        value: "Better than ±1% (0.4% - 100% F.S.)"
      },
      {
      ...
      {
        label: "Working piston speed",
        value: "0 ~ 30 mm/min (adjustable)"
      },
      {
        label: "Working piston maximum stroke",
        value: "600 mm"
      },
      {
        label: "Lower platen size",
        value: "850 × 850 mm"
      },
      {
        label: "Lower platen movement method",
        value: "Motor drive"
      },
      {
        label: "Displacement measurement range",
        value: "0 - 900 mm"
      },
      {
        label: "Displacement accuracy",
        value: "Better than ±1% F.S."
      },
      {
      ...
      {
        label: "Hydraulic power unit dimensions",
        value: "1200 × 600 × 1300 mm"
      },
      {
        label: "Control cabinet dimensions",
        value: "1500 × 870 × 880 mm"
      },
      {
        label: "Equipment weight",
        value: "Approx. 16,000 kg"
      }
    ],
    hasManual: null,
    hasVideo: null,
  ...
  },
  {
    ...
    specifications: [
      ...
      {
        label: "Clear distance between columns",
        value: "X direction: 1200 mm, Y direction: 1030 mm"
      },
      {
        label: "Main actuator",
        value: "Maximum load :10000 kN"
      },
      {
        label: "Load accuracy",
        value: "Better than ±1% (0.4% - 100% F.S.)"
      ...
      {
        label: "Hydraulic power unit dimensions",
        value: "1360 × 600 × 1625 mm"
      },
      {
        label: "Control cabinet dimensions",
        value: "1960 × 870 × 880 mm"
      },
      {
        label: "Equipment weight",
        value: "Approx. 40,000 kg"
      }
    ],
    hasManual: null,
    hasVideo: null,
  ...
  },
  {
    ...
    specifications: [
      ...
      {
        label: "Clear distance between columns",
        value: "X direction: 1520 mm, Y direction: 1030 mm"
      },
      {
        label: "Main actuator",
        value: "Maximum load :20000 kN"
      },
      {
        label: "Load accuracy",
        value: "Better than ±1% (0.4% - 100% F.S.)"
  ...
  },
  {
    ...
    specifications: [
      {
        label: "Test cylinder dimensions",
        value: "300 × 300 × 600 mm"
      },
      {
      ...
      {
        label: "Piezometer hole spacing",
        value: "50 mm"
      },
      {
        label: "Loading equipment",
        value: "Lever loading system"
      },
      {
        label: "Water supply tank dimensions",
        value: "140 × 140 × 140 mm"
      },
      {
        label: "Water storage tank dimensions",
        value: "260 × 400 × 400 mm"
      },
      {
        label: "Voltage",
        value: "AC 220V"
  ...
  },
  {
    ...
    features: [],
    customized: [
      "The specifications and spatial dimensions are customizable to meet customer needs."
    ],
    standards: [],
    specifications: [
      {
      ...
      {
        label: "Clear space between columns",
        value: "400 × 320 × 700 mm"
      },
      {
        label: "Upper/lower platen size",
        value: "700 × 650 × 100 mm"
      },
      {
        label: "Weight",
        value: "1200 kg"
  ...
  },
  {
    ...
    specifications: [
      ...
      {
        label: "Clear space between columns",
        value: "560 × 420 × 1100 mm"
      },
      {
        label: "Upper/lower platen size",
        value: "850 × 700 × 130 mm"
      },
      {
        label: "Weight",
        value: "1500 kg"
  ...
  },
  {
    ...
    specifications: [
      {
        label: "",
        value: "It can be customized based on the tests to be performed on the material."
      }
    ],
    hasManual: null,
    hasVideo: null,
  ...
  },
  {
    ...
    specifications: [
      {
        label: "",
        value: "Slump cone (mm)：100±1"
      },
      {
        label: "",
        value: "Bottom inner diameter (mm)：200±1"
      },
      {
        label: "",
        value: "Height (mm)：300±1"
      },
      {
        label: "",
        value: "Container inner diameter (mm)：240±2"
      },
      {
        label: "",
        value: "Inner height (mm)：200±2"
      },
      {
        label: "",
        value: "Vibrator frequency (Hz)：50±2"
      },
      {
        label: "",
        value: "Vibrating table amplitude (with empty container) (mm)：0.5±0.02"
      },
      {
        label: "",
        value: "Motor power (W)：550"
      },
      {
        label: "",
        value: "Timer range(S)：0.1-99.9"
      },
      {
        label: "",
        value: "Overall dimensions (mm)：380×520×870"
      },
      {
        label: "",
  ...
  },
  {
    ...
    specifications: [
      {
        label: "Bowl density (kg)",
        value: "3"
      },
      {
        label: "Power supply (kW)",
        value: "0.75"
      },
      {
        label: "Power supply voltage",
  ...
  },
  {
    ...
    specifications: [
      {
        label: "Sand storage cylinder diameter",
        value: "150mm"
      },
      {
        label: "Sand storage cylinder volume",
        value: "4771cm³"
      },
      {
        label: "Flowing sand hole diameter",
        value: "15mm"
      },
      {
        label: "Calibration tank inner diameter",
        value: "150mm"
      },
      {
        label: "Calibration tank outer diameter",
        value: "200mm"
      },
      {
        label: "Base plate side length",
        value: "400mm"
      },
      {
        label: "Base plate depth",
        value: "50mm"
      }
    ],
    hasManual: null,
  ...
  },
  {
    ...
    features: [],
    customized: [
      "Various specifications are available. The number of grooves and the width can be selected according to actual requirements."
    ],
    standards: [],
    specifications: null,
    hasManual: null,
  ...
  },
  {
    ...
    features: [],
    customized: [
      "The load ring can be configured according to actual requirements."
    ],
    standards: [],
    specifications: [
      {
