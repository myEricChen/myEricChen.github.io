(function() {
    ...
    document.getElementById('breadcrumb-category').href = `../products/index.html?category=${category ? category.id : ''}`;
    ...
    function showError(message) {
        ...
        container.innerHTML = `
            <div class="loading" style="color: #d71920;">
                ...
                <p>${message}</p>
                <a href="../products/index.html" class="btn btn-primary" style="margin-top: 20px;">Browse Equipment Series</a>
            </div>
        `;
    }
})();